...
3. Jenkins New Job – A new Jenkins job (task - 1) is being created, allowing the user to select different project types.
   
![img2](https://github.com/user-attachments/assets/2d415f66-9178-4cba-abb4-aad5fd43cebd)

5. Jenkins Console Output – Shows the successful installation and activation of the NGINX web server via a Jenkins job.
   
![img3](https://github.com/user-attachments/assets/4fd8bd88-d97a-4ec3-9c1e-2f2bd6daaa12)

7. Jenkins Job Status – Displays the successful execution of the Jenkins job for installing NGINX on an Ubuntu VM.
